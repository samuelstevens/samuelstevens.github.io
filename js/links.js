...
var $author$project$Links$resourceDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Links$Resource,
...
var $author$project$Links$getData = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Links$GotData, $author$project$Links$allDecoder),
		url: 'misc/links.json'
	});
...
var $author$project$Links$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Links$getData,
					A2($elm$core$Task$perform, $author$project$Links$AdjustTimeZone, $elm$time$Time$here)
				])));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Links$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AdjustTimeZone':
				var zone = msg.a;
						...
						case 'BadUrl':
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										err: $elm$core$Maybe$Just('Bad URL: ' + url)
									}),
								$elm$core$Platform$Cmd$none);
						case 'Timeout':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										err: $elm$core$Maybe$Just('Timed out waiting for response.')
									}),
								$elm$core$Platform$Cmd$none);
						case 'NetworkError':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										err: $elm$core$Maybe$Just('Network error.')
									}),
								$elm$core$Platform$Cmd$none);
						case 'BadStatus':
							var status = err.a;
								...
								_Utils_update(
									model,
									{
										err: $elm$core$Maybe$Just(
											'Got response: ' + $elm$core$String$fromInt(status))
									}),
								$elm$core$Platform$Cmd$none);
						default:
							var body = err.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										err: $elm$core$Maybe$Just('Got bad body: ' + body)
									}),
								$elm$core$Platform$Cmd$none);
					}
				}
...
var $author$project$Links$viewError = function (err) {
	return A2(
		$elm$html$Html$p,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Links$monthToString = function (month) {
	switch (month.$) {
		case 'Jan':
			return '01';
		case 'Feb':
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(resource.title)
								]))
						])),
					A2(
					$elm$html$Html$td,
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($author$project$Links$viewDate, zone, resource.added))
						]))
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Links$viewTableRow(model.zone),
					resources))
			]));
};
...
var $author$project$Links$main = $elm$browser$Browser$element(
	{
		init: $author$project$Links$init,
		subscriptions: function (model) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Links$update,
		view: $author$project$Links$view
	});
_Platform_export({'Links':{'init':$author$project$Links$main(
